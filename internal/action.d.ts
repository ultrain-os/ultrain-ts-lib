...
export declare namespace env {
    ...
    function send_inline(data: usize, len: i32): void;
    function send_context_free_inline(data: usize, len: i32): void;
    ...
    function set_result_str(cstr: usize): void;
    function set_result_int(val: u64): void;
}
