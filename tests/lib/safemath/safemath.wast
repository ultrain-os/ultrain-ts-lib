(module
 ...
 (data (i32.const 1444) "\13\00\00\00S\00a\00f\00e\00M\00a\00t\00h\00 \00a\00d\00d\00 \00f\00a\00i\00l\00e\00d")
 (data (i32.const 1488) "\0d\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s")
 (data (i32.const 1520) "\0b\00\00\00s\00a\00f\00e\00m\00a\00t\00h\00.\00t\00s")
 (data (i32.const 1548) "\"\00\00\00M\00i\00n\00u\00e\00n\00d\00 \00i\00s\00 \00g\00r\00e\00a\00t\00e\00r\00 \00t\00h\00a\00n\00 \00s\00u\00b\00t\00r\00a\00h\00e\00n\00d")
 (data (i32.const 1620) "\13\00\00\00C\00a\00n\00\'\00t\00 \00d\00i\00v\00i\00d\00i\00n\00g\00 \00b\00y\00 \000")
 (data (i32.const 1664) "\1c\00\00\00$\00{\00a\00}\00 \00m\00u\00l\00i\00t\00i\00p\00l\00y\00 \00$\00{\00b\00}\00 \00o\00v\00e\00r\00f\00l\00o\00w")
 (data (i32.const 1724) "\13\00\00\00e\00r\00r\00o\00r\00 \00s\00u\00b\00 \00o\00p\00e\00r\00a\00t\00i\00o\00n")
 ...
 (func $~lib/memory/memcpy (; 22 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (loop $continue|0
   (if
 ...
 (func $~lib/memory/memmove (; 23 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (if
   (i32.eq
    (get_local $0)
 ...
 (func $~lib/memory/memory.copy (; 24 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
 ...
 (func $../../../lib/safemath/SafeMath.add (; 30 ;) (type $III) (param $0 i64) (param $1 i64) (result i64)
  (local $2 i64)
 ...
 (func $../../../lib/safemath/SafeMath.sub (; 31 ;) (type $III) (param $0 i64) (param $1 i64) (result i64)
  (call $../../../src/utils/ultrain_assert
   (i64.le_u
    (get_local $1)
    (get_local $0)
 ...
 (func $../../../lib/safemath/SafeMath.div (; 32 ;) (type $III) (param $0 i64) (param $1 i64) (result i64)
  (call $../../../src/utils/ultrain_assert
   (i64.ne
    (get_local $1)
    (i64.const 0)
 ...
 (func $../../../lib/safemath/SafeMath.mul (; 33 ;) (type $III) (param $0 i64) (param $1 i64) (result i64)
  (local $2 i64)
  (if
   (i64.eq
    (get_local $0)
 ...
 (func $../../../lib/safemath/SafeMath.sqrt (; 34 ;) (type $II) (param $0 i64) (result i64)
  (local $1 i64)
  (local $2 i64)
  (set_local $1
   (i64.div_u
 ...
 (func $../../../lib/safemath/SafeMath.square (; 35 ;) (type $II) (param $0 i64) (result i64)
  (call $../../../lib/safemath/SafeMath.mul
   (get_local $0)
   (get_local $0)
  )
 )
 (func $../../../lib/safemath/SafeMath.pwr (; 36 ;) (type $III) (param $0 i64) (param $1 i64) (result i64)
  (local $2 i64)
  (local $3 i64)
  (if (result i64)
   (i64.eq
 ...
 (func $safemath/TestSafeMath#test (; 37 ;) (type $iIv) (param $0 i32) (param $1 i64)
 ...
 (func $safemath/apply (; 38 ;) (type $IIIIv) (param $0 i64) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (if
   (i64.eq
