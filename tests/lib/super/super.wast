(module
 ...
 (data (i32.const 1712) "\08\00\00\00a\00d\00d\00T\00i\00g\00e\00r\00")
 ...
 (data (i32.const 1800) "\0c\00\00\00T\00i\00g\00e\00r\00 \00n\00a\00m\00e\00:\00 \00")
 (data (i32.const 1832) "\n\00\00\00.\00 \00r\00e\00g\00i\00o\00n\00:\00 \00")
 (data (i32.const 1856) "\t\00\00\00 \00.\00 \00k\00i\00n\00d\00:\00 \00")
 (table $0 1 anyfunc)
 ...
 (global $HEAP_BASE i32 (i32.const 1880))
 (export "memory" (memory $0))
 (export "table" (table $0))
 (export "apply" (func $test_super/apply))
 (start $start)
 ...
 (func $../../../src/contract/Contract#get:receiver (; 31 ;) (type $iI) (param $0 i32) (result i64)
  get_local $0
  i64.load
 )
 (func $../../../src/contract/Contract#get:action (; 32 ;) (type $ii) (param $0 i32) (result i32)
  get_local $0
  i32.load offset=8
 )
 ...
 (func $../../../src/contract/Contract#filterAction (; 36 ;) (type $iIi) (param $0 i32) (param $1 i64) (result i32)
  (local $2 i32)
  get_local $0
 ...
 (func $../../../src/contract/Contract#onInit (; 37 ;) (type $iv) (param $0 i32)
  nop
 )
 (func $~lib/internal/typedarray/TypedArray<u8>#constructor (; 38 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/datastream/DataStream#read<i32> (; 43 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  get_local $0
  i32.load
  get_local $0
 ...
 (func $~lib/string/String.fromUTF8 (; 47 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/datastream/DataStream#readString (; 48 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $test_super/Animal#deserialize (; 49 ;) (type $iiv) (param $0 i32) (param $1 i32)
  get_local $0
  get_local $1
 ...
 (func $test_super/Tiger#deserialize (; 50 ;) (type $iiv) (param $0 i32) (param $1 i32)
  get_local $0
  get_local $1
  call $test_super/Animal#deserialize
  get_local $0
  get_local $1
  call $~lib/datastream/DataStream#readString
  i32.store offset=8
 )
 (func $test_super/Tester#addTiger (; 51 ;) (type $iiv) (param $0 i32) (param $1 i32)
  get_global $../../../src/log/Log
  i32.const 1800
  call $../../../src/log/Logger#s
  get_local $1
 ...
 (func $../../../src/contract/Contract#onError (; 52 ;) (type $iv) (param $0 i32)
  nop
 )
 (func $../../../src/contract/Contract#onStop (; 53 ;) (type $iv) (param $0 i32)
  nop
 )
 (func $test_super/apply (; 54 ;) (type $IIIIv) (param $0 i64) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  i32.const 0
  ...
  if
   ...
   if
    ...
    get_local $6
    get_local $5
    call $test_super/Tiger#deserialize
    get_local $4
    get_local $6
    call $test_super/Tester#addTiger
   end
   get_local $4
   i32.const 1624
   call $../../../src/contract/Contract#isAction
