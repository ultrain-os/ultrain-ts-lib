(module
 ...
 (import "test_fun" "getAge" (func $test_fun/Football#getAge (param i32) (result i64)))
 ...
 (export "Football#getName" (func $test_fun/Football#getName))
 (export "Football#getAge" (func $test_fun/Football#getAge))
 (export "Football#say" (func $test_fun/Football#say))
 (export "apply" (func $test_fun/apply))
 (export "memory" (memory $0))
 (start $start)
 (func $Contract#get:receiver (; 5 ;) (type $iI) (param $0 i32) (result i64)
  (i64.load
   (get_local $0)
  )
 )
 (func $Contract#set:receiver (; 6 ;) (type $iIv) (param $0 i32) (param $1 i64)
  (i64.store
   (get_local $0)
   (get_local $1)
  )
 ...
 (func $test_fun/Football#getName (; 15 ;) (type $ii) (param $0 i32) (result i32)
  (i32.const 1408)
 )
 ...
 (func $../src/utils/printstr (; 24 ;) (type $iv) (param $0 i32)
 ...
 (func $test_fun/Football#say (; 25 ;) (type $iIv) (param $0 i32) (param $1 i64)
  (call $../src/utils/printstr
   (call $test_fun/Football#getName
    (get_local $0)
   )
  )
 )
 (func $../lib/contract/Contract#constructor (; 26 ;) (type $iIi) (param $0 i32) (param $1 i64) (result i32)
  (local $2 i32)
  (i64.store
   (if (result i32)
    (get_local $0)
 ...
 (func $test_fun/apply (; 30 ;) (type $IIIv) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i32)
  (if
   (i64.eq
