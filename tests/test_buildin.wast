(module
 ...
 (export "redirect_sum" (func $test_buildin/redirect_sum))
 ...
 (func $~lib/map/Map<String_String>#clear (; 6 ;) (type $iv) (param $0 i32)
  (i32.store
   (get_local $0)
 ...
 (func $~lib/map/Map<String_String>#constructor (; 7 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $~lib/msg/Msg#constructor (; 8 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (if (result i32)
   (get_local $0)
   (get_local $0)
 ...
 (func $test_buildin/redirect_sum (; 9 ;) (type $v)
  (call $~lib/map/Map<String_String>#clear
   (get_global $map)
  )
 )
