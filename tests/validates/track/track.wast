(module
 ...
 (global $HEAP_BASE i32 (i32.const 1872))
 (memory $0 1)
 ...
 (func $track/TestTrack#test (; 29 ;) (type $iv) (param $0 i32)
 ...
 (func $track/apply (; 30 ;) (type $IIIIv) (param $0 i64) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (if
