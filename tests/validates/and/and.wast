(module
 ...
 (data (i32.const 1488) "\0b\00\00\00b\00e\00g\00i\00n\00 \00t\00e\00s\00t\00:\00")
 (export "memory" (memory $0))
 (export "apply" (func $testand/apply))
 (start $start)
 ...
 (func $~lib/internal/typedarray/TypedArray<u8_u32>#constructor (; 12 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/datastream/DataStream#constructor (; 13 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (i32.store
   (tee_local $0
    (if (result i32)
 ...
 (func $../../../src/contract/DataStreamFromCurrentAction (; 14 ;) (type $i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (set_local $0
 ...
 (func $../../../lib/name_ex/NameEx#constructor (; 16 ;) (type $iIIi) (param $0 i32) (param $1 i64) (param $2 i64) (result i32)
  (local $3 i32)
  (i64.store
   (tee_local $0
    (if (result i32)
 ...
 (func $../../../src/contract/Contract#setActionName (; 17 ;) (type $iIIv) (param $0 i32) (param $1 i64) (param $2 i64)
  (i32.store offset=8
   (get_local $0)
 ...
 (func $../../../src/contract/Contract#onInit (; 18 ;) (type $iv) (param $0 i32)
  (nop)
 )
 ...
 (func $~lib/datastream/DataStream#read<u8> (; 24 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (set_local $1
   (i32.load8_u
    (i32.add
 ...
 (func $~lib/datastream/DataStream#readVarint32 (; 25 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/array/Array<u8>#__set (; 30 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $3
   (i32.load
 ...
 (func $~lib/datastream/DataStream#readVector<u8> (; 31 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (set_local $1
 ...
 (func $~lib/datastream/DataStream#read<i32> (; 32 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (set_local $1
   (i32.load
    (i32.add
 ...
 (func $~lib/array/Array<i32>#__set (; 34 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $3
   (i32.load
 ...
 (func $~lib/datastream/DataStream#readVector<i32> (; 35 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (set_local $1
 ...
 (func $~lib/array/Array<u8>#__get (; 38 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (set_local $2
   (i32.load
    (get_local $0)
 ...
 (func $testand/testAnd#testAnd (; 44 ;) (type $iiiiv) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (set_local $5
   (if (result i32)
 ...
 (func $testand/testAnd#test (; 45 ;) (type $iiiiv) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
 ...
 (func $../../../src/contract/Contract#onStop (; 46 ;) (type $iv) (param $0 i32)
  (nop)
 )
 (func $testand/apply (; 47 ;) (type $IIIIv) (param $0 i64) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
   ...
   (block
    ...
    (if
     ...
     (block
      ...
      (set_local $8
       (call $~lib/datastream/DataStream#readVector<i32>
        (get_local $5)
       )
      )
      (call $testand/testAnd#test
       (get_local $4)
       (get_local $6)
       (get_local $7)
       (get_local $8)
