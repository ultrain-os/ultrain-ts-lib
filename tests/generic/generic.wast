(module
 ...
 (global $HEAP_BASE i32 (i32.const 2112))
 (memory $0 1)
 ...
 (data (i32.const 1652) "\13\00\00\00I\00n\00i\00t\00 \00a\00c\00t\00i\00o\00n\00 \00f\00a\00i\00l\00e\00d\00.")
 (data (i32.const 1696) "\02\00\00\00h\00i")
 (data (i32.const 1704) "(\00\00\00T\00e\00s\00t\00G\00e\00n\00e\00r\00i\00c\00 \00c\00l\00a\00s\00s\00 \00i\00n\00s\00t\00a\00n\00c\00e\00d\00 \00a\00s\00 \00i\00n\00t\00e\00g\00e\00r\00:\00 ")
 (data (i32.const 1788) "\0e\00\00\00h\00e\00l\00l\00o\00 \00u\00l\00t\00r\00a\00i\00n\00.")
 (data (i32.const 1820) "\'\00\00\00T\00e\00s\00t\00G\00e\00n\00e\00r\00i\00c\00 \00c\00l\00a\00s\00s\00 \00i\00n\00s\00t\00a\00n\00c\00e\00d\00 \00a\00s\00 \00s\00t\00r\00i\00n\00g\00:\00 ")
 (data (i32.const 1904) "\1d\00\00\00E\00r\00r\00o\00r\00:\00 \00u\00n\00k\00n\00o\00w\00n\00 \00a\00c\00t\00i\00o\00n\00 \00n\00a\00m\00e\00 \00:\00 ")
 (data (i32.const 1968) " \00\00\00.\001\002\003\004\005\00a\00b\00c\00d\00e\00f\00g\00h\00i\00j\00k\00l\00m\00n\00o\00p\00q\00r\00s\00t\00u\00v\00w\00x\00y\00z")
 (data (i32.const 2041) "\08\00\00\0d\00\00\004\00\00\00\00\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.\00\00\00.")
 (export "apply" (func $generic/apply))
 ...
 (func $../../lib/log/Logger#i (; 31 ;) (type $iIii) (param $0 i32) (param $1 i64) (param $2 i32) (result i32)
 ...
 (func $../../lib/log/Logger#i|trampoline (; 32 ;) (type $iIii) (param $0 i32) (param $1 i64) (param $2 i32) (result i32)
  (block $1of1
   (block $0of1
    (block $oob
 ...
 (func $../../lib/action/Action#read_params_nth_string (; 33 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i64)
  (set_local $3
 ...
 (func $~lib/array/Array<String>#push (; 34 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $3
 ...
 (func $generic/TestGeneric<u8>#constructor (; 42 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (i32.store8
   (if (result i32)
    (get_local $0)
 ...
 (func $generic/TestGeneric<u8>#showType (; 43 ;) (type $iv) (param $0 i32)
  (call $../../lib/log/Logger#flush
   (block (result i32)
    (set_global $~argc
     (i32.const 1)
 ...
 (func $generic/TestGeneric<String>#constructor (; 44 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (i32.store
   (if (result i32)
    (get_local $0)
 ...
 (func $generic/TestGeneric<String>#showType (; 45 ;) (type $iv) (param $0 i32)
  (call $../../lib/log/Logger#flush
   (call $../../lib/log/Logger#s
    (call $../../lib/log/Logger#s
     (get_global $../../lib/log/Log)
 ...
 (func $~lib/array/Array<u8>#__set (; 46 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (if
   (i32.ge_u
    (get_local $1)
 ...
 (func $~lib/array/Array<u8>#__get (; 47 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (if (result i32)
   (i32.lt_u
    (get_local $1)
 ...
 (func $../../lib/name/NameToString (; 48 ;) (type $Ii) (param $0 i64) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (set_local $2
 ...
 (func $generic/apply (; 49 ;) (type $IIIv) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (if
   ...
   (if
    ...
    (if
     ...
     (call $generic/TestGeneric<String>#showType
      (call $generic/TestGeneric<String>#constructor
       (i32.const 0)
       (i32.const 1788)
      )
     )
     (call $generic/TestGeneric<u8>#showType
      (call $generic/TestGeneric<u8>#constructor
       (i32.const 0)
       (i32.const 65)
      )
     )
