(module
 ...
 (data (i32.const 1408) "\08\00\00\00f\00o\00o\00t\00b\00a\00l\00l")
 (data (i32.const 1428) "\0d\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s")
 (data (i32.const 1460) "\0e\00\00\00~\00l\00i\00b\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s")
 (data (i32.const 1492) "\03\00\00\00s\00a\00y")
 (export "Car#primaryKey" (func $test_interface/Car#primaryKey))
 (export "Car#deserialize" (func $test_interface/Car#deserialize))
 (export "Car#serialize" (func $test_interface/Car#deserialize))
 (export "Contract#get:receiver" (func $Contract#get:receiver))
 (export "Contract#set:receiver" (func $Contract#set:receiver))
 (export "Football#getName" (func $test_interface/Football#getName))
 (export "Football#say" (func $test_interface/Football#say))
 (export "apply" (func $test_interface/apply))
 (export "memory" (memory $0))
 (start $start)
 (func $test_interface/Car#primaryKey (; 4 ;) (type $iI) (param $0 i32) (result i64)
  (i64.const 0)
 )
 (func $test_interface/Car#deserialize (; 5 ;) (type $iiv) (param $0 i32) (param $1 i32)
  (nop)
 )
 (func $Contract#get:receiver (; 6 ;) (type $iI) (param $0 i32) (result i64)
  (i64.load
   (get_local $0)
  )
 )
 (func $Contract#set:receiver (; 7 ;) (type $iIv) (param $0 i32) (param $1 i64)
  (i64.store
   (get_local $0)
   (get_local $1)
  )
 ...
 (func $../src/datastream/DataStream#constructor (; 13 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (i32.store
   (if (result i32)
    (get_local $0)
 ...
 (func $../lib/contract/DataStreamFromCurrentAction (; 14 ;) (type $i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (drop
 ...
 (func $../lib/contract/Contract#getDataStream (; 15 ;) (type $ii) (param $0 i32) (result i32)
  (call $../lib/contract/DataStreamFromCurrentAction)
 )
 (func $test_interface/Football#getName (; 16 ;) (type $ii) (param $0 i32) (result i32)
  (i32.const 1408)
 )
 ...
 (func $../src/utils/printstr (; 25 ;) (type $iv) (param $0 i32)
 ...
 (func $test_interface/Football#say (; 26 ;) (type $iIv) (param $0 i32) (param $1 i64)
  (call $../src/utils/printstr
   (call $test_interface/Football#getName
    (get_local $0)
   )
  )
 )
 ...
 (func $test_interface/apply (; 31 ;) (type $IIIv) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i32)
  (if
   (i64.eq
   ...
   (block
    ...
    (if
     ...
     (call $test_interface/Football#say
      (get_local $3)
