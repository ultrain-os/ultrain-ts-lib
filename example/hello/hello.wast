(module
 ...
 (global $HEAP_BASE i32 (i32.const 1900))
 (memory $0 1)
 ...
 (data (i32.const 1688) "\02\00\00\00h\00i\00")
 (data (i32.const 1696) "\03\00\00\00h\00i\00 \00")
 (data (i32.const 1712) " \00\00\00.\001\002\003\004\005\00a\00b\00c\00d\00e\00f\00g\00h\00i\00j\00k\00l\00m\00n\00o\00p\00q\00r\00s\00t\00u\00v\00w\00x\00y\00z\00")
 (data (i32.const 1784) "\0d\00\00\00\00\00\00\00.............\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 1816) "\f8\06\00\00\0d\00\00\00")
 (data (i32.const 1824) "\00\00\00\00")
 (data (i32.const 1832) "\04\00\00\00n\00u\00l\00l\00")
 (data (i32.const 1848) "\17\00\00\00~\00l\00i\00b\00/\00i\00n\00t\00e\00r\00n\00a\00l\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s\00")
 ...
 (func $../../src/contract/Contract#constructor (; 25 ;) (type $iIi) (param $0 i32) (param $1 i64) (result i32)
  (local $2 i32)
  (i64.store
   (tee_local $0
    (if (result i32)
 ...
 (func $~lib/internal/typedarray/TypedArray<u8_u32>#constructor (; 26 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/datastream/DataStream#constructor (; 27 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (i32.store
   (tee_local $0
    (if (result i32)
 ...
 (func $../../src/contract/DataStreamFromCurrentAction (; 28 ;) (type $i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (set_local $0
 ...
 (func $../../src/contract/Contract#getDataStream (; 29 ;) (type $ii) (param $0 i32) (result i32)
  (call $../../src/contract/DataStreamFromCurrentAction)
 )
 (func $../../lib/name_ex/NameEx#constructor (; 30 ;) (type $iIIi) (param $0 i32) (param $1 i64) (param $2 i64) (result i32)
  (local $3 i32)
  (i64.store
   (tee_local $0
    (if (result i32)
 ...
 (func $../../src/contract/Contract#setActionName (; 31 ;) (type $iIIv) (param $0 i32) (param $1 i64) (param $2 i64)
  (i32.store offset=8
   (get_local $0)
 ...
 (func $~lib/datastream/DataStream#read<u64> (; 37 ;) (type $iI) (param $0 i32) (result i64)
  (local $1 i64)
  (set_local $1
   (i64.load
    (i32.add
 ...
 (func $~lib/array/Array<u8>#__set (; 38 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $3
   (i32.load
 ...
 (func $~lib/array/Array<u8>#__get (; 39 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (set_local $2
   (i32.load
    (get_local $0)
 ...
 (func $~lib/internal/string/allocateUnsafe (; 41 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (if
   (i32.eqz
 ...
 (func $~lib/internal/string/copyUnsafe (; 42 ;) (type $iiiiiv) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $~lib/string/String#concat (; 43 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/string/String.__concat (; 44 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (if
   (i32.eqz
    (get_local $0)
   )
 ...
 (func $../../lib/name/RN (; 45 ;) (type $Ii) (param $0 i64) (result i32)
  (local $1 i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $../../src/account/RNAME (; 46 ;) (type $Ii) (param $0 i64) (result i32)
  (call $../../lib/name/RN
   (get_local $0)
  )
 )
 (func $hello/HelloContract#hi (; 47 ;) (type $iIv) (param $0 i32) (param $1 i64)
  (call $../../src/log/Logger#flush
   (call $../../src/log/Logger#s
    (call $../../src/log/Logger#s
     (get_global $../../src/log/Log)
 ...
 (func $../../src/contract/Contract#onStop (; 48 ;) (type $iv) (param $0 i32)
  (nop)
 )
 (func $hello/apply (; 49 ;) (type $IIIIv) (param $0 i64) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i64)
  (if
