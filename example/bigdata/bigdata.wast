(module
 ...
 (import "env" "big_int_gcd" (func $bigdata/env.big_int_gcd (param i32 i32 i32 i32)))
 ...
 (import "env" "big_int_cmp" (func $bigdata/env.big_int_cmp (param i32 i32) (result i32)))
 ...
 (data (i32.const 1280) "\03\00\00\00g\00c\00d")
 (data (i32.const 1296) "\03\00\00\00 \00:\00 ")
 (data (i32.const 1308) "\03\00\00\00c\00m\00p")
 (data (i32.const 1320) "\0c\00\00\00c\00m\00p\00 \00r\00e\00s\00u\00l\00t\00:\00 ")
 (export "memory" (memory $0))
 (export "apply" (func $bigdata/apply))
 (start $start)
 ...
 (func $~lib/memory/memset (; 13 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i64)
  (local $4 i32)
  (if
   (i32.eqz
 ...
 (func $../../src/datastream/DataStream#constructor (; 16 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (i32.store
   (if (result i32)
    (get_local $0)
 ...
 (func $../../lib/contract/DataStreamFromCurrentAction (; 17 ;) (type $i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (drop
 ...
 (func $../../lib/contract/Contract#getDataStream (; 18 ;) (type $ii) (param $0 i32) (result i32)
  (call $../../lib/contract/DataStreamFromCurrentAction)
 )
 (func $../../src/name_ex/NameEx#constructor (; 19 ;) (type $iIIi) (param $0 i32) (param $1 i64) (param $2 i64) (result i32)
  (local $3 i32)
  (i64.store
   (if (result i32)
    (get_local $0)
 ...
 (func $../../src/name_ex/char_to_symbol_ex (; 21 ;) (type $iI) (param $0 i32) (result i64)
  (local $1 i32)
  (if
   (i32.eq
    (i32.and
 ...
 (func $../../src/name_ex/NEX (; 22 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i64)
 ...
 (func $../../src/name_ex/NameEx._eq (; 23 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (if (result i32)
   (tee_local $2
    (i64.eq
 ...
 (func $../../src/datastream/DataStream#readVarint32 (; 25 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (loop $continue|0
 ...
 (func $../../src/datastream/DataStream#readString (; 26 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (if
 ...
 (func $bigdata/BigData#gcd (; 38 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (call $bigdata/env.big_int_gcd
   (i32.load
    (tee_local $0
     (call $~lib/internal/typedarray/TypedArray<u8_u32>#constructor
      (i32.const 0)
 ...
 (func $bigdata/BigData#cmp (; 39 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (set_local $3
   (call $bigdata/env.big_int_cmp
    (call $../../src/utils/string2cstr
     (get_local $1)
    )
    (call $../../src/utils/string2cstr
 ...
 (func $bigdata/apply (; 40 ;) (type $IIIIv) (param $0 i64) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (if
