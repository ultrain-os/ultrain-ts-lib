(module
 ...
 (global $HEAP_BASE i32 (i32.const 1508))
 (memory $0 1)
 ...
 (data (i32.const 1408) "\07\00\00\00s\00e\00t\00p\00r\00i\00v")
 (data (i32.const 1428) "\0e\00\00\00~\00l\00i\00b\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s")
 ...
 (export "Bios#setpriv" (func $bios/Bios#setpriv))
 (export "Bios#setalimits" (func $bios/Bios#setalimits))
 (export "Bios#setglimits" (func $bios/Bios#setglimits))
 (export "Bios#setprods" (func $bios/Bios#setprods))
 (export "Bios#reqauth" (func $bios/Bios#reqauth))
 (export "apply" (func $bios/apply))
 (export "memory" (memory $0))
 (start $start)
 (func $Contract#get:receiver (; 7 ;) (type $iI) (param $0 i32) (result i64)
  (i64.load
   (get_local $0)
  )
 )
 (func $Contract#set:receiver (; 8 ;) (type $iIv) (param $0 i32) (param $1 i64)
  (i64.store
   (get_local $0)
   (get_local $1)
  )
 ...
 (func $bios/Bios#setpriv (; 17 ;) (type $iIiv) (param $0 i32) (param $1 i64) (param $2 i32)
 ...
 (func $bios/Bios#setalimits (; 18 ;) (type $iIIIIv) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i64) (param $4 i64)
  (call $../../src/ultrain-lib/env.require_auth
   (i64.load
    (get_local $0)
   )
 ...
 (func $bios/Bios#setglimits (; 19 ;) (type $iIIIv) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i64)
  (call $../../src/ultrain-lib/env.require_auth
   (i64.load
    (get_local $0)
   )
 ...
 (func $bios/Bios#setprods (; 20 ;) (type $iv) (param $0 i32)
  (local $1 i32)
  (call $../../src/ultrain-lib/env.require_auth
   (i64.load
    (get_local $0)
 ...
 (func $bios/Bios#reqauth (; 21 ;) (type $iIv) (param $0 i32) (param $1 i64)
  (call $../../src/ultrain-lib/env.require_auth
   (get_local $1)
  )
 )
 (func $../../lib/contract/Contract#constructor (; 22 ;) (type $iIi) (param $0 i32) (param $1 i64) (result i32)
  (local $2 i32)
  (i64.store
   (if (result i32)
    (get_local $0)
 ...
 (func $../../src/utils/char_to_symbol (; 24 ;) (type $iI) (param $0 i32) (result i64)
  (local $1 i32)
  (if
   (if (result i32)
    (tee_local $1
 ...
 (func $../../src/utils/N (; 25 ;) (type $iI) (param $0 i32) (result i64)
  (local $1 i32)
  (local $2 i64)
  (local $3 i64)
  (local $4 i32)
 ...
 (func $../../src/datastream/DataStream#read<u64> (; 26 ;) (type $iI) (param $0 i32) (result i64)
  (local $1 i64)
  (set_local $1
   (i64.load
    (i32.add
 ...
 (func $../../src/datastream/DataStream#read<u8> (; 27 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (set_local $1
   (i32.load8_u
    (i32.add
 ...
 (func $bios/apply (; 28 ;) (type $IIIv) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i32)
  (if
   (i64.eq
